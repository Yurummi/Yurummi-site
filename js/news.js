        ...
        html: `
            ...
            <div style="display: flex; flex-wrap: wrap; gap: 30px; margin-bottom: 40px;">
                ...
                <div style="flex: 1 1 35%;">
                    ...
                    <p class="np-text">Первым идёт оригинальный вариант автора, а дальше — лучшие и самые забавные работы прямиком с трансляций. Кто-то решил пошутить про кружку, кто-то вспомнил классические мемы канала, а некоторые работы были настолько абсурдными, что вызвали приступ смеха у всей редакции. Такие интерактивы в очередной раз доказывают, насколько у нас креативное комьюнити!</p>
                    <p class="np-text">Подобные мероприятия обязательно будут повторяться в будущем. Готовы посмеяться? Листайте слайдер и наслаждайтесь народным творчеством!</p>
                </div>
            </div>
            ...
            <div style="display: flex; flex-wrap: wrap; gap: 30px; margin-bottom: 40px; border-top: 1px dashed #444; padding-top: 30px;">
                ...
                <div style="flex: 1 1 35%;">
                    ...
                    <p class="np-text">Когда эфир находился на грани срыва, на помощь пришло искусство! Юрумми и Маку провели невероятно уютный совместный стрим в Magma, где решили поменяться ролями: художница рисовала нашего лиса, а он с огромным энтузиазмом взялся за её персонажа!</p>
                    <p class="np-text">Результат превзошёл все ожидания! Посмотрите на эти шедевры (кликайте на стрелочки). Совместное творчество всегда рождает что-то уникальное и сближает, не так ли?</p>
                </div>
                <!-- Блок 2: Картинки (16:9 Слайдер) -->
                <div style="flex: 1 1 60%;">
                    <div class="np-slider" style="aspect-ratio: 16/9; background: transparent; border: none;">
            ...
            <!-- РЯД 4: Телеграм и Доп инфа -->
            <div style="display: flex; flex-wrap: wrap; gap: 30px; margin-bottom: 20px; border-top: 1px dashed #444; padding-top: 30px;">
                <!-- Блок 4: Телеграм -->
                <div style="flex: 1 1 35%; min-width: 300px; max-width: 40%;">
                ...
                <!-- Блок 4: Текст -->
                <div style="flex: 1 1 50%;">
                    <h3 class="np-title">ПОСЫЛКА, ОТ КОТОРОЙ СВЕЛО ОЛДСКУЛЫ</h3>
                    <p class="np-text">Вы только посмотрите на это сокровище! Редакция не могла пройти мимо свежего поста в Telegram, где Юрумми похвастался неожиданным подгоном от подписчика. Картриджи с классическими играми про Соника, шикарные арты, наклейки, и, внимание... настоящие «Кириешки»!</p>
                    <p class="np-text">Кажется, кто-то вычислил идеальную формулу того, как задобрить стримера и мотивировать его на новые ретро-прохождения. Заряд ностальгии получен, сухарики съедены, а значит, нас ждёт ещё больше эпичных (и горящих) эфиров.</p>
                    <p class="np-text">Чтобы не пропускать такие внезапные анбоксинги и закулисье стримов, обязательно заглядывайте в уютный Telegram-канал нашего лиса. Там всегда происходит что-то интересное!</p>
                </div>
            </div>
        `
    },
        ...
        html: `
            ...
            <div class="np-row" style="margin-bottom: 30px; gap: 15px;">
                ...
                <div style="flex: 1;">
                    <div class="np-image-box" onclick="openLightbox(this)" role="button" tabindex="0">
                        <picture style="width: 100%; display: block; aspect-ratio: 1/1;">
                            <source srcset="img/news/news_06_09_2026_comic_3.webp" type="image/webp">
            ...
            <div class="np-row" style="margin-bottom: 30px; gap: 15px;">
                <div style="flex: 1;">
                    <div class="np-image-box" onclick="openLightbox(this)" role="button" tabindex="0">
                        <picture style="width: 100%; display: block; aspect-ratio: 1/1;">
                            <source srcset="img/news/news_06_09_2026_comic_4.webp" type="image/webp">
            ...
            <div style="margin-bottom: 20px;">
                <h3 class="np-title">КУДА ПРОПАЛИ СТРИМЫ? 🤒</h3>
                <p class="np-text">На прошлой неделе мы потеряли целых два стрима. Один эфир сорвался из-за технических проблем с ПК, а вот субботний — по вине предательского вируса. Стример официально заболел.</p>
                <p class="np-text">По этой причине расписание на новую неделю пришлось немного сдвинуть: <strong>в понедельник (7 сентября) стрима не будет</strong>, чтобы дать организму время восстановиться. Встречаемся во <strong>вторник, среду, пятницу и субботу</strong>. Пейте чай, кушайте витамины и не болейте!</p>
            </div>
        `
    },
    {
        ...
        html: `
            ...
            <div class="np-row" style="margin-bottom: 30px;">
                ...
                <div class="np-col-40">
                    ...
                    <p class="np-text">Как только сбор закроется, мы сразу крутим колесо судьбы и узнаём победителя. Готовьте самые безумные идеи! И помните, вы абсолютно свободны в своём выборе — можете закинуть голоса на Тейлза, Эми, или даже... на беременного Эггмана (хоть я бы этого очень не хотел, но запретить вам не могу!). Выбор за вами, а расхлебывать мне!</p>
                </div>
            </div>
            ...
            <div class="np-row">
                ...
                <div class="np-col-40">
                    ...
                    <p class="np-text"><span class="dropcap">Г</span>рандиозный скандал потряс интернет! Недавно Юрумми с любовью и старанием нарисовал этот милый арт, посвященный Маку. Проведя часы за прорисовкой деталей, он радостно скинул результат ей прямо во время стрима и попросил заценить...</p>
                    <p class="np-text">Каково же было его разочарование, когда Маку, посмотрев на рисунок, публично заявила, что это, очевидно, сгенерировано нейросетью! Никакие оправдания не помогли доказать подлинность ручной работы.</p>
                    <p class="np-text" style="padding: 10px; background: #2a2a2a; border-left: 3px solid #ff3385;">Итог трагичен: стример страшно обиделся. Теперь он принципиально заявляет всем, что действительно является нейросетью, и отказывается от своей человечности. Восстание машин официально началось с непризнанного искусства.</p>
                </div>
            </div>
            
            <!-- РЯД 4: Прощание с летом -->
            <div class="np-row" style="margin-top: 40px;">
                <div style="flex: 1; min-width: 100%; border-top: 1px dashed #444; padding-top: 20px;">
                    <h3 class="np-title" style="text-align: center; color: #ff9966;">ПРОЩАЙ, ЛЕТО... 🍂</h3>
                    <p class="np-text" style="text-align: center; max-width: 800px; margin: 0 auto; font-style: italic; color: #bbb;">
                        Вот и подошли к концу эти яркие, беззаботные дни. Лето всегда пролетает незаметно, оставляя после себя терпкое послевкусие ночных стримов, смешных моментов и общих побед в чате. Становится чуточку грустно от того, что солнце всё раньше прячется за горизонт, а вечера становятся прохладнее. Но не стоит унывать! Впереди нас ждут самые уютные осенние трансляции — с пледом, горячим чаем и новыми играми. Спасибо, что провели это замечательное лето вместе с нами. Дальше будет только уютнее! ✨
                    </p>
                </div>
            </div>
        `
