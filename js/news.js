        ...
        html: `
            <div style="color: #ccc; text-align: justify;">
                ...
                <div style="margin-bottom: 40px;">
                    ...
                    <p class="np-text">Но для тех, кто пропустил этот странный вечер или хочет закрепить его в памяти — хорошие новости! Уже на этой неделе на одном из наших YouTube-каналов выйдет новое видео с нарезкой тех самых загадочных моментов со стрима. Вы сможете воочию увидеть, как ломались границы реальности, и, возможно, найти зацепки, которые мы упустили. Ждём с нетерпением!</p>
                    <div style="clear: both;"></div>
                </div>
