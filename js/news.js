        ...
        html: `
            <div style="color: #ccc; text-align: justify;">
                ...
                <div style="margin-bottom: 40px;">
                    ...
                    <h3 class="np-title" style="margin-top: 0;">СЮРПРИЗ НА СТРИМЕ: КТО ЗА МИКРОФОНОМ?</h3>
                    <p class="np-text">Субботний вечер обещал быть обычным... но что-то пошло не так, а подготовка к эфиру с треском провалилась! В итоге за микрофоном внезапно оказалась Маку. Зрители в чате сначала буквально сходили с ума, пытаясь понять, что происходит, выдавая фразы вроде: <em>"Кто сейчас за микрофоном?!"</em> и <em>"Почему мы путаем вас?!"</em>.</p>
                    <p class="np-text">Вместо сурового спидрана мы получили невероятно забавное зрелище: Маку очень мило пыталась пройти одну из частей Соника, которую Юрумми уже давно осилил. Весь чат просто умирал со смеху, наблюдая за её стараниями и искренними реакциями на происходящее в игре. Это был полный хаос, но безумно веселый!</p>
                    <p class="np-text">Для тех, кто пропустил этот спонтанный перформанс — хорошие новости! Уже на этой неделе на одном из наших YouTube-каналов выйдет новое видео с нарезкой тех самых смешных моментов со стрима. Вы сможете воочию увидеть, как Маку покоряла Соника, и посмеяться вместе с нами. Ждём с нетерпением!</p>
                    <div style="clear: both;"></div>
                </div>
